    ...
    <table cellspacing="0" cellpadding="0">
      <tbody>
        <tr>
        	<td class="right">
            <label>类别：</label>
            <select name="formType" id="formType" class="formText iconTree" style="width:15em" ></select>
            <label>关键字：</label>
            <span class="position:relative;">
            <input type="text" id="title"  maxlength="10"    class="formText searchkey" placeholder="表单名称"/>
            </span>
         ...
         <table width="100%"   id="myTable"  class="pretty"  cellspacing="0" cellpadding="0"  >
			        <thead>
				         <tr >
					        <th class="num">序号</th>
					        <th style="width:60%">表单名称</th>
					        <th style="width:40%;" >表单类别</th>
