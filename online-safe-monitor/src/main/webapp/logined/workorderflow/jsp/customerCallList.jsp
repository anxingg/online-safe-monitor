...
<script type="text/javascript" src="${ctx}logined/workorderflow/js/customerCallList.js?version=${version}"></script>
	...
	<div class="list">
				...
				<tbody>
					<tr>
						<td class="right">
						    ...
						    &nbsp;&nbsp;
							<span id="seatCon">显示范围：
								<select id="searchScope">
									<option value="1">与我相关</option>
									<option value="-1">全部</option>
								</select>
							</span>
							...
							<span class="position:relative;"> 
								<span id="upgjz">
									<input type="text" id="searchkey2" class="formText searchkey" maxlength="12"
										style="width:120px;" placeholder="来电人/联系电话"/>
								</span>
							</span> 
		...
		<table width="100%" cellspacing="0" cellpadding="0" class="pretty"
			...
			<thead>
				<tr>
					<th class="num">序号</th>
					<th style="width:110px">工单编号</th>
					<th style="width:80px">工单类别</th>
					<th style="width:70px">来电人</th>
					<th style="width:95px">联系电话</th>
					<th style="width:110px">受理时间</th>
					<th style="width:70px">受理人员</th>
