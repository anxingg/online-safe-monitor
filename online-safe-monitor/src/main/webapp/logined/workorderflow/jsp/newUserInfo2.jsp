...
<%@ include file="../../../common/taglibs.jsp"%>
 <table border="0" class="inputTable1 mt10" style="table-layout:fixed">
    <tr>
      ...
      <td><input style="width:80%" name=""  value="<s:property value="#request.phoneOne" />" class="formText" type="text" id="uphone" maxlength="12" onkeyup="this.value=this.value.replace(/[^0-9]/g,'')" /></td>
      <th><label>座机号码</label></th>
      <td><input style="width:80%" name="" value="<s:property value="#request.phoneTwo" />" class="formText" type="text" id="umobile" maxlength="13" onkeyup="this.value=this.value.replace(/[^0-9]/g,'')" /></td>
    </tr>
    <tr>
