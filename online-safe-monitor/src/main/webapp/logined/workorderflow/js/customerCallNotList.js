...
//		funPlaceholder(document.getElementById("searchkey"));
		...
		$("#search").click(function() {
			$.removeTableCookie('SpryMedia_DataTables_listTable_customerCallNotList.jsp');
			getNotDataTables();
		});
						 ...
						 { "aTargets" : [1], //工单编号1
						   "fnRender" : function(oObj) {
							...
							"fnRender" : function(oObj) {
								var instanceId = oObj.aData.instanceId;
								var vid = oObj.aData.vid;
								var operateUrl = oObj.aData.operateUrl+"?instanceId="+encodeURI(instanceId)+"&vid="+vid+"&fromPage=back";
