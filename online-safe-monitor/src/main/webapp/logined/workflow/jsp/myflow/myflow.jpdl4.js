(function($) {
	...
	$.extend(true, myflow.config.tools.states, {
		start : {
			...
			img : {
				src : $("#proName").val()
						+ '/logined/workflow/jsp/myflow/img/48/start_event_empty.png',
				width : 48,
				height : 48
			},
			...
			img : {
				src : $("#proName").val()
						+ '/logined/workflow/jsp/myflow/img/48/end_event_terminate.png',
				width : 48,
				height : 48
			},
			attr : {
		...
		fork : {
			...
			img : {
				src : $("#proName").val()
						+ '/logined/workflow/jsp/myflow/img/48/gateway_parallel.png',
				width : 48,
				height : 48
			},
			attr : {
		...
		task : {
			...
			img : {
				src : $("#proName").val()
						+ '/logined/workflow/jsp/myflow/img/48/task_empty.png',
				width : 48,
				height : 48
			},
			props : {
		...
		decision : {
			...
			img : {
				src : $("#proName").val()
						+ '/logined/workflow/jsp/myflow/img/48/gateway_exclusive.png',
				width : 48,
				height : 48
			},
			props : {
