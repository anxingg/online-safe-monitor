	...
	<input type="hidden" id="moduleName" value='<%=moduleName%>' />
       ...
       <div class="tab">
         <ul>
           ...
           <li class="current" id="liSelectRole" ><a   href="javascript:void(0);"  id="btnSelectRole" >工作角色</a></li>
         </ul>  
       </div>
	...
	<script type="text/javascript">
		...
		function searchUser(type) {
			...
			var dataParam = {
				...
				//张东领注释，原因：选择工作角色时，显示角色下面的人员
				/* 'moduleName' : moduleName,
				'roleName' : 'siter,seatLeader', */
				'showType' :
	<%=showType%>
		};
// 		alert('type='+type+',searchName='+searchName+',moduleName='+moduleName+',showType='+<%=showType%>);
	        ...
	        $.ajax({
	            url : "${ctx}hotlineuser/selectUser.action",
	            type : 'post',
	            dataType : 'json',
	            data : dataParam,
