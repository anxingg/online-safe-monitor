	...
	<head>
		...
		<script type="text/javascript">
			$(document).ready(function(){
				$("#areaName").focus();
				var areaName=art.dialog.data("subAddressName");
				var orderNum=art.dialog.data("orderNum");
			...
			function addSubmit(){
				...
				if(valid){
					...
					var areaNameNew=$("#areaName").val();
					var grade=art.dialog.data("grade");
					var orderNum=$("#orderNum").val();
					var isRealName=art.dialog.data("isRealName");
					var modArea=art.dialog.data("modifyAreaFun");
					
					var areaNameOld=art.dialog.data("subAddressName");
					
					if(areaNameOld==areaNameNew){
						i=0;
					}else{
						i=1;
					}
					
					modArea(i,obj,id,code,areaNameNew,grade,orderNum,isRealName);
					art.dialog.close();
				}
			}
		</script>
