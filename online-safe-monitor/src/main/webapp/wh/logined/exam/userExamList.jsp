...
<head>
	...
	<script type="text/javascript" src="${ctx}wh/js/exam/userExamList.js"></script>
</head>
<body>
		...
		<div class="searchArea">
			<ul>
				...
				<li><input type="button" class="searchButton" value="查询" id="search"/>
					<div class="fButton greenBtn" id="xz" style="display: none;"> <span class="add" id="addPaper">新增</span></div>
				</li>
				<li></li>
			</ul>
		</div>
