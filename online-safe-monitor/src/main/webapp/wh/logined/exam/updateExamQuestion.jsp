...
<jsp:include page="../head.jsp" />
    ...
    <script type="text/javascript" src="${ctx}wh/js/exam/updateExamQuestion.js"></script> 
...
<form id="form1">
	...
	<div class="bread-line">
		<label>当前位置：</label><a href="#">首页</a>&gt;<a href="#">试题</a>&gt;&nbsp;修改
	</div>
	
                 <div class="formPage">
	 <div class="formbg">
        <div class="big_title">修改<em>（试题）</em></div>
        <div class="content_form">
                <table width="100%" cellspacing="0" cellpadding="0" border="0" class="inputTable" id="tabInfo">
                    <tr>
                 <th><label>试题名称：</label></th>
                <td><input type="text" class="formText" id="title" name="title" valid="required"  errMsg="question.questionTitle_not_null" maxlength="100"/></td>
                </tr>
              ...
              <tr>
                ...
                <td><label class="radio"><input type="radio" name="questionItem" value="0" checked="checked"/>单选题</label>
	                <label class="radio"><input type="radio" name="questionItem" value="1"/>多选题</label>
	                </td>
              </tr>
    ...
    <div class="buttonArea"> 
			<input type="button"class="formButton_green" value="修改" hidefocus="" onclick="addQuestion('update');"/>
