...
<jsp:include page="../head.jsp" />
	...
	<!-- 验证end -->
    <script type="text/javascript" src="${ctx}wh/js/plans/updatePlans.js?version=${version}"></script>
    <style type="text/css">
...
<body>
	...
	<div class="bread-line">
		<label>当前位置：</label><a href="#">首页</a>&gt;<a href="#">应急预案</a>&gt;&nbsp;修改
	</div>
	 <div class="formPage">
	 <div class="formbg">
        <div class="big_title">修改<em>（应急预案）</em></div>
