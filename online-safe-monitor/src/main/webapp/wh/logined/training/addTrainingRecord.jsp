...
<head>
	...
	<title>新增安全培训记录</title>
    <script type="text/javascript" src="${ctx}wh/js/training/addTrainingRecord.js"></script> 
...
<body>
	<div class="bread-line">
		<label>当前位置：</label><a href="#">首页</a>&gt;<a href="#">安全培训记录</a>&gt;新增
	</div>
    <div class="formPage">
	 <div class="formbg">
        <div class="big_title">新增<em>（安全培训记录）</em></div>
                 <form id="form1">
    ...
    <div class="buttonArea"> 
			<input type="button"class="formButton_green" value="确定" hidefocus="" onclick="addTraining();"/>
