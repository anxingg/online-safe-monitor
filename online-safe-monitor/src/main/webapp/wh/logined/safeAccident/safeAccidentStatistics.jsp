...
<head>
	...
	<!-- 清除分页cookie end -->
	<script type="text/javascript" src="${ctx}wh/js/safeAccident/safeAccidentStatistics.js"></script>
...
<body>
	...
	<div class="bread-line">
		<label>当前位置：</label><a href="#">安全生产事故</a>&gt;&nbsp;安全生产事故统计
	</div>
	<div class="list">
		<div class="searchArea">
			<ul>
				<li><label>事故发生时间：</label><input type="text" class="formText Wdate" id="beginTime" onfocus="WdatePicker({maxDate:'#F{$dp.$D(\'endTime\')}',skin:'default',dateFmt:'yyyy-MM-dd'})" /> - <input type="text" class="formText Wdate" id="endTime" onfocus="WdatePicker({minDate:'#F{$dp.$D(\'beginTime\')}' ,skin:'default',dateFmt:'yyyy-MM-dd'})" /></li>
				...
				<li><label>企业名称：</label><select id="accidentCharacter"><option value="1">自然灾害&bnsp;</option></select></li>
				</s:if> --%>
