...
<head>
    ...
    <script type="text/javascript" src="${ctx}wh/js/process/addProcess.js"></script> 
...
<body>
	<div class="bread-line">
		<label>当前位置：</label><a href="#">首页</a>&gt;<a href="#">工艺流程管理</a>&gt;新增
	</div>
    <div class="formPage">
	 <div class="formbg">
        <div class="big_title">新增<em>（工艺流程）</em></div>
                 <form id="form1">
