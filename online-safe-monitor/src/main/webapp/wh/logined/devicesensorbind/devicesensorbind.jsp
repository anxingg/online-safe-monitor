...
<script type="text/javascript" src="${ctx}wh/js/devicesensorbind/devicesensorbind.js?version=${version}"></script>
<script type="text/javascript" src="${ctx}wh/js/devicesensorbind/devicesensorbind_tree.js?version=${version}"></script>
</head>
<body>
...
<div class="mainpage">
  <div class="leftMenu">
    <div class="service-menu">
      <h1>所有采集设备</h1>
      <input type="text" class="search" placeholder="请输入企业、安装位置"   id="btnSearch" />
