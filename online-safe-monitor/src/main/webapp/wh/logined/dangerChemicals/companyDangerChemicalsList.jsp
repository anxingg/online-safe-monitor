...
<head>
	...
	<!-- 附件下载 end -->
	<script type="text/javascript" src="${ctx}wh/js/dangerChemicals/companyDangerChemicalsList.js"></script>
...
<body>
	...
	<div class="list">
		<div class="searchArea">
			<ul>
				<li><label>物质名称：</label><input type="text" class="formText" id="materialName" maxlength="32" /></li>
				<li><input type="button" class="searchButton"  value="查询" /><div class="fButton greenBtn"> <span class="add" onclick="addOne();">新增</span></div></li>
			</ul>
		</div>
