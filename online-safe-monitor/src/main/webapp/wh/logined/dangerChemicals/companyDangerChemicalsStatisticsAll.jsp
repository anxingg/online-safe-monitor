...
<head>
	...
	<!-- 清除分页cookie end -->
	<script type="text/javascript" src="${ctx}wh/js/dangerChemicals/companyDangerChemicalsStatisticsAll.js"></script>
...
<body>
	...
	<div class="bread-line">
		<label>当前位置：</label><a href="#">危险化学品</a>&gt;&nbsp;危险化学品统计
	</div>
	<div class="list">
		<div class="searchArea">
			<ul>
				...
				<select id="statisticsType">
					...
					<option value="2"  selected="selected">企业</option>
				</select>
				</li>
