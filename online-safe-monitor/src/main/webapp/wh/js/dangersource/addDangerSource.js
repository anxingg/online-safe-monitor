...
//	});
	...
	$("#form1 input[name='ds.rvalue']").change(function(){
		var v = $(this).val();
		if(v >= 100){
			$("#form1 input[name='ds.dangerLevel']").val(1);
			$("#form1 input[name='ds.dangerLevel']").next("span").text('一级');
		}else if(v >= 50){
			$("#form1 input[name='ds.dangerLevel']").val(2);
			$("#form1 input[name='ds.dangerLevel']").next("span").text('二级');
		}else if(v >= 10){
			$("#form1 input[name='ds.dangerLevel']").val(3);
			$("#form1 input[name='ds.dangerLevel']").next("span").text('三级');
		}else if(v > 0){
			$("#form1 input[name='ds.dangerLevel']").val(4);
			$("#form1 input[name='ds.dangerLevel']").next("span").text('四级');
		}else {
			$("#form1 input[name='ds.dangerLevel']").val(10);
			$("#form1 input[name='ds.dangerLevel']").next("span").text('其他');
		}
//	     * 一级     R≥100
//	     * 二级     100>R≥50
//	     * 三级     50>R≥10
