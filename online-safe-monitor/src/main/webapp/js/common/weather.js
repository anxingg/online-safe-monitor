...
{
    var dataParam={
        'url':'http://61.4.185.209/data/cityinfo/101180101.html' // 信阳101180601 郑州101180101  101181601=驻马店 
    };
...
//                $("#w_temperature").html(obj['weatherinfo']['temp2']+"~"+obj['weatherinfo']['temp1']);
                $("#w_weather").html(obj['weatherinfo']['city']+"&nbsp;"+obj['weatherinfo']['weather']+"&nbsp;"+obj['weatherinfo']['temp2']+"~"+obj['weatherinfo']['temp1']);
            }
        }
    });
}