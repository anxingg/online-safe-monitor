...
qy_lang.message = {
		...
		msg_contentInfo_not_null : "消息内容不能为空，请输入消息内容！",
...
qy_lang.addressbook = {
		...
		msg_update_address_error : "更新联系人失败！",
...
qy_lang.email = {
		...
		email_box_add_success : "添加邮件箱成功！",
		email_box_update_success : "修改邮件箱成功！",
...
qy_lang.daily = {
		...
		daily_review_content_count_max : "点评内容最大字数为5000，请修改。",
		daily_review_review_content_count_max : "回复内容最大字数为5000，请修改。",
 ...
 */
qy_lang.customJpdl = {
		process_name_not_null : "对不起！流程名称不能为空！",
		process_order_must_int : "流程排序号必须是整数!",
		process_name_expr_not_null : "对不起！文号生成器不能为空!",
		...
		process_type_not_null : "对不起！请选择流程分类！"
};
/**
 * 群组验证
 */
 ...
 */
qy_lang.notify = {
		notify_subject_not_null : "对不起，公告标题不能为空",
		notify_content_not_null : "对不起，公告内容不能为空",
		notify_userName_not_null : "对不起，公告发布对象不能为空",
		notify_topDays_scope : "置顶天数范围为0-365",
		notify_reason_not_null : "对不起，审批意见不能为空",
		notify_reason_length : "批复内容字数应为0-100",
		notify_clear_confirm_info : '确定要清空查阅情况吗？',
		notify_auditer : '公告已提交审批',
		notify_fabu : '公告发布成功',
		notify_baocun : '公告保存成功',
...
qy_lang.user = {
		...
		user_group_not_null : "部门不能为空！",
		user_phone_not_null : "用户手机不能为空！",
		user_phone_format_error : "用户手机格式不正确！",
		user_email_format_error : "用户邮箱格式不正确！",
		user_phone2_format_error : "工作电话格式不正确！",
		password_not_null : "登录密码不能为空！",
		password_limit : "登录密码不能少于6位！",
		...
		loginName_is_exist : "登录账号已存在！",
		loginName_not_null : "登录账号不能为空！",
 ...
 */
qy_lang.calendar = {
		calendar_content_not_null : "事务内容不能为空，请输入事务内容。",
		calendar_content_too_long: "事务内容不能超过1000个字！",
		...
		calendar_begTime_not_null : "起始时间不能为空！",
		calendar_endTime_not_null : "结束时间不能为空！",
		calendar_days_scope : "天的范围为0-365",
		calendar_hours_scope : "小时范围为0-24",
		calendar_minutes_scope : "分钟范围为0-59",
		calendar_less_than_begTime : '结束时间不能早于起始时间！',
		calendar_less_than_begDate : '结束日期不能早于起始日期！',
		remaind_less_than_begTime : '提醒时间不能大于起始时间！',
...
qy_lang.desktop = {
		...
		confirm_delete_desktop_screen : "删除桌面屏幕,将删除该屏幕全部应用模块,确定要删除吗？",
...
qy_lang.customerCall = {
		...
		businessType_not_null : "请输选择业务类别！",
...
//即时消息
qy_lang.question = {
		questionTitle_not_null : "请输入试题名称!",
		questionItem_not_null	: "请输入选项!"
};
...
qy_lang.training = {
		trainYear_not_null : "请选择年度!",
		details_max_length:"培训内容最大字数为1000，请修改!",
		details_not_null:"培训内容不能为空!",
		charge_not_null:"负责人不能为空!",
		trainRate_not_null:"培训时间不能为空!",
		trainObject_not_null:"培训对象不能为空!",
		trainForm_not_null:"培训形式不能为空!",
		memo_not_null:"备注不能为空!",
		memo_max_length:"备注最大字符为256，请修改！",
		subject_not_null:"培训名称不能为空!",
		trainTime_not_null:"培训时间不能为空!",
		speaker_not_null:"主讲人不能为空!",
		address_not_null:"培训地点不能为空!"
};
...
qy_lang.emergency = {
		departName_not_null : "机构/人名称不能为空!",
...
qy_lang.relief = {
		goodName_not_null : "装备名称不能为空!",
		goodUnit_not_null:"单位不能为空!",
		goodNum_not_null:"数量不能为空！"
};
...
qy_lang.process = {
		processName_not_null : "工艺名称不能为空!",
		introduction_not_null : "工艺介绍不能为空!"
};
