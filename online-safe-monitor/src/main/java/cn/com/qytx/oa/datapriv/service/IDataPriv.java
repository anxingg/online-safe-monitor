...
public interface IDataPriv extends BaseService<DataPriv>,Serializable 
{
     ...
     * @return String
     */
    String getDataPrivHql(String vidStr, String moudleName, String subMoudle,
     ...
     * @return DataPriv
     */
    DataPriv getDataPrivByRefId(Integer refId, String moduleName);
     ...
     * @return int
     */
    int updateDataPriv(Integer refId, String moduleName, String roleIds, String roleNames,
     ...
     * @return int
     */
    int updateDataPrivById(Integer dataprivid, String roleIds, String roleNames,
            String userIds, String userNames, String groupIds, String GroupName);
     ...
     * @param userNames 人员名字集合
     */
    void deleteFileSort(String refId, String moduleName, String roleIds, String groupIds,
     ...
     */
    List<DataPriv> getFileSortById(String finalFileSortIds, String finalFileSortIdPrivs);
     ...
     * @return List<DataPriv>
     */
    List<DataPriv> getFileSortByPerson(String userIds);
     ...
     * @return List 
     */
    List<?> getFileSortNedPriv(String vidStr, String moudleName, String subMoudle,
            Integer userId, Integer groupId, List<Integer> roleIdList);
    /**
     * 功能：根据人员得到权限列表
     * @param userIds 人员Id
     * @return List<DataPriv>
     */
    List<DataPriv> getChildFileSortById(int fileSortId);
     ...
     * @return
     */
    DataPriv getDataPrivById(Integer id);
