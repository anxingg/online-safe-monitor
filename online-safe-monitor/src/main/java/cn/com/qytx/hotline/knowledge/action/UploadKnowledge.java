...
import cn.com.qytx.hotline.util.GetMethodUtil;
import cn.com.qytx.hotline.util.PropertiesUtil;
import cn.com.qytx.hotline.util.ZipDecompression;
...
public class UploadKnowledge extends BaseActionSupport
{
     ...
     * log4j日志对象
     */
    private final static MonitorLogger logger =new Log4jImpl(KnowledgeAction.class);
    /**
     * 上传文件
     */
