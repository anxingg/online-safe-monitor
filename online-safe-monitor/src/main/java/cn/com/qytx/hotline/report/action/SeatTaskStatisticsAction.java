...
public class SeatTaskStatisticsAction extends BaseActionSupport
{
     ...
     * log4j日志对象
     */
    private final static MonitorLogger logger =new Log4jImpl(SeatTaskStatisticsAction.class);
        ...
        try
        {
            ...
            if (userInfo != null)
            {
                ...
                Page<SeatWorkload> pageInfo = iMsiWorkloadService.findSeatWorkloadGroupByState(
                        ...
                        groupId, workIds, IsForkGroup,getLoginUser().getCompanyId());
                /** 得到结果 */
        ...
        try
        {
            ...
            if (userInfo != null)
            {
                ...
                if (!StringUtil.isEmpty(fromPage) && fromPage.equals("seat"))
                {
                    ...
                    int isZxbz = (Integer) (getSession().getAttribute("isZxbz"));
                    if (1 == isZxbz)
                    {
                        workIds = "";
                    }
