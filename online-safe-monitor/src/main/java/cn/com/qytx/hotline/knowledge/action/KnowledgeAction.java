...
import cn.com.qytx.hotline.knowledge.service.IKnowledge;
...
{
    private final static MonitorLogger loger =new Log4jImpl(KnowledgeAction.class);
    /**
     * 序列号
     */
    ...
    public String initIndex()
    {
        ...
        loger.info("操作人"+getLoginUser().getUserName()+"初始化索引");
        ajax(result);
        return null;
    }
    ...
    public String delIndex()
    {
        ...
        loger.info("操作人"+getLoginUser().getUserName()+"清空索引");
        ajax(result);
        return null;
    }
