package cn.com.qytx.hotline.knowledge.dao;
...
public class KnowledgeTypeDao extends BaseDao<KnowledgeType, Integer> implements Serializable
{
    ...
    public List<KnowledgeType> findAllKnowledgeType(UserInfo user, Integer isPrivate, Integer isOnly)
    {
     ...
     * @return KnowledgeType
     */
    public List<KnowledgeType> findByParentId(Integer parentId)
    {
        // 排序
        Order order = new Order(Direction.ASC, "orderIndex");
        Sort s = new Sort(order);
        String hql = "parentId = ? and isDelete = 0";
        return super.findAll(hql, s, parentId);
    }
