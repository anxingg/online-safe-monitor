...
public interface DangerChemicalsService {
	 ...
	 */
	DangerChemicalsInfo saveOrUpdate(DangerChemicalsInfo dangerChemicals);
	 ...
	 * @return DangerChemicals
	 */
	DangerChemicalsInfo findOne(Integer id);
	 ...
	 * @param dangerChemicals
	 * @param whroletype
	 * @return Page<DangerChemicals>
	 */
	Page<DangerChemicalsInfo> findByPage(Pageable pageable,
	 ...
	 * @return
	 */
	List<DangerChemicalsInfo> findAll();
}
