...
<jsp:include page="../head.jsp" />
    ...
    <script type="text/javascript" src="${ctx}wh/js/safetyManagePerson/updateSafetyManagePerson.js?version=${version}"></script>
...
<body>
	...
	<div class="bread-line">
		<label>当前位置：</label><a href="#">首页</a>&gt;<a href="#">企业管理</a>&gt;&nbsp;安全管理人员修改
	</div>
	<div class="formPage">
	 <div class="formbg">
        <div class="big_title">修改<em>（安全管理人员）</em></div>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                            	...
                            	<input id="nan" type="radio" name="sex" value="1"/> 男&nbsp;&nbsp;
                            	<input id="nv" type="radio" name="sex" value="0"/> 女
                            </td>
                        </tr>
                        <tr>
    ...
    <div class="buttonArea"> 
			<input type="button"class="formButton_green" value="确定" hidefocus="" onclick="updatePerson();"/>
