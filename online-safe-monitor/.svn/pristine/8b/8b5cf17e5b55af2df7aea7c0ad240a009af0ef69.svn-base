...
<jsp:include page="../head.jsp" />
    ...
    <script type="text/javascript" src="${ctx}js/logined/js_lang_cn.js"></script>
        <script type="text/javascript" src="${ctx}wh/js/exam/addExamTest.js"></script> 
    
</head>
<body>
	<div class="bread-line">
		<label>当前位置：</label><a href="#">首页</a>&gt;<a href="#">考试</a>&gt;&nbsp;新增
	</div>
	 <div class="formPage">
	 <div class="formbg">
        <div class="big_title">新增<em>（考试）</em></div>
    ...
    <div class="buttonArea"> 
			<input type="button"class="formButton_green" value="确定" hidefocus="" onclick="addExamTest('add');"/>
