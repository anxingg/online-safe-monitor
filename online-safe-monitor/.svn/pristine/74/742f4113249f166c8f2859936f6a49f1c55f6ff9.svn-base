...
<head>
	...
	<script type="text/javascript" src="${ctx}wh/js/safeAccident/safeAccidentList.js"></script>
	...
	<div class="list">
		<div class="searchArea">
			<ul>
				...
				<li><label>事故时间：</label><input type="text" class="formText Wdate" id="occurredTimeStr" onfocus="WdatePicker({isShowToday: false, skin:'default',dateFmt:'yyyy'})" /></li>
				...
				<li><label>关键字：</label><input type="text" class="formText" id="keyword" placeholder="事故名称、事故简介、事故后果、事故处理情况" style="width: 350px;"/></li>
				<li><input type="button" class="searchButton" value="查询" /><div class="fButton greenBtn"> <span class="add" onclick="addSafeAccident();">新增</span></div></li>
			</ul>
		</div>
