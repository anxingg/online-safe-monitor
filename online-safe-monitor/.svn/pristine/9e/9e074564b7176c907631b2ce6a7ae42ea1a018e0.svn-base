...
<head>
	...
	<script type="text/javascript" src="${ctx}wh/js/fee/feeUsedList.js"></script>
...
<body>
	...
	<div class="bread-line">
		<label>当前位置：</label><a href="#">安全生产费用使用</a>&gt;&nbsp;安全生产费用使用列表
	</div>
	<div class="list">
		<div class="searchArea">
			<ul>
				...
				<li><label>资金用向：</label><input type="text" class="formText" id="keyword" /></li>
