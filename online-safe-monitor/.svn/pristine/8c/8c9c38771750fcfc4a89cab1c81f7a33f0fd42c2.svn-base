...
<script type="text/javascript" src="${ctx}/logined/workflow/js/prepCreate.js"></script>
</head>
<body>
		...
		<div class="pop-panel-inner">
				...
				<div style="margin-left: 150px" class="pop-panel-container">
						...
						<div class="buttonArea">
								...
								&nbsp;&nbsp;
								<input hideFocus="" onclick="window.history.back(); return false;" value="返 回" type="button" class="formButton">
								</div>
							-->
