...
{
    private final static MonitorLogger loger =new Log4jImpl(KnowledgeImpl.class);
    /**
     * 序列号
     */
    ...
    public void deleteById(Integer id)
    {
        ...
        loger.info(user.getUserName()+"删除知识库 id="+id);
        LuceneUtil.delete(this.findById(id));
    }
