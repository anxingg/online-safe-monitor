...
import cn.com.qytx.hotline.knowledge.dao.KnowledgeDao;
import cn.com.qytx.hotline.knowledge.dao.KnowledgeTypeDao;
...
public class KnowledgeTypeImpl extends BaseServiceImpl<KnowledgeType> implements IKnowledgeType, Serializable
{
    ...
    public int deleteById(Integer id)
    {
        ...
        List<KnowledgeType> typeList = knowledgeTypeDao.findByParentId(id);
        ...
        loger.info(user.getUserName()+"删除知识库类型 id="+id);
        return 0;
    }
     ...
     */
    @Override
    public List<TreeNode> findAllKnowledgeType(boolean containAll, UserInfo user, Integer isPrivate, Integer isOnly)
    {
        ...
        List<KnowledgeType> typeList = knowledgeTypeDao.findAllKnowledgeType(user, isPrivate, isOnly);
        if (null != typeList && !typeList.isEmpty())
        {
