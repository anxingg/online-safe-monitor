...
<link href="${ctx}/common/frame/css/base.css" rel="stylesheet" type="text/css" />
<link href="${ctx}/common/frame/css/public.css" rel="stylesheet" type="text/css" />
<link href="${ctx}/plugins/datatable/table_style.css" rel="stylesheet" type="text/css" />
<link href="${ctx}/common/frame/css/panel.css" rel="stylesheet" type="text/css" />
<link href="${ctx}/common/frame/css/explorer.css" rel="stylesheet" type="text/css" />
