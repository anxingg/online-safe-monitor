...
<div class="bread-line">
		<s:if test="#request.instentceid==1">
		<label>当前位置：</label><a href="#">首页</a>&gt;<a href="#">公告管理</a>&gt;&nbsp;公告通知设置
		</s:if>
		<s:elseif test="#request.instentceid==2">
		<label>当前位置：</label><a href="#">首页</a>&gt;<a href="#">政策法规</a>&gt;&nbsp;政策法规通知设置
		</s:elseif>
</div>
