				...
				<table width="100%" cellspacing="0" cellpadding="0" border="0"
					...
					<tbody>
						<tr>
							...
							<td><input type="text"
								...
								<td rowspan="3"><dl class="myphoto">
										<dt>
											<img src="${ctx}/flat/images/hy.png" id="view"/>
											<a href="#" style="display:none" id="clean">重置LOGO</a>
										</dt>
										<dd>
						...
						<tr>
							...
							<td><input name="company.email" type="text" valid="isEmail"
						...
						<tr>
							...
							<td><input name="company.tel" type="text"
								valid="isPhoneSimple" errmsg="record.must_be_right_phone_no"
