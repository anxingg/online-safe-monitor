...
//		funPlaceholder(document.getElementById("searchkey"));
		...
		$("#search").click(function() {
			$.removeTableCookie('SpryMedia_DataTables_listTable_customerCallAllList.jsp');
			getAllDataTables();
		});
						 ...
						 { "aTargets" : [1], //工单编号1
						   "fnRender" : function(oObj) {
							...
							var operateUrl = "/jbpmworkorder/customerCallViewBack.action"+"?vid="+vid+"&instanceId="+encodeURI(instanceId);
							 return "<a href='"+basePath+operateUrl+"'>"+cclSn+"</a>";
					 	}
					 },{
							"aTargets" : [ 9 ],
							"fnRender" : function(oObj) {
...
//								return "<a href='"+basePath+"/"+operateUrl+"'>"+operateName+"</a><a href='#' onclick='delCustomerCallLog("+ vid + ");' id='deleteCCL'>删除</a>";
								return "<a href='"+basePath+"/"+operateUrl+"'>"+operateName+"</a><a href='#' onclick='delCustomerCallLog("+ vid + ");' id='deleteCCL'>删除</a>";
						}
						} ]
					});
