...
<head>
    ...
    <script type="text/javascript" src="${ctx}wh/js/training/addTraining.js"></script> 
...
<body>
	<div class="bread-line">
		<label>当前位置：</label><a href="#">首页</a>&gt;<a href="#">年度培训计划管理</a>&gt;新增
	</div>
    <div class="formPage">
	 <div class="formbg">
        <div class="big_title">新增<em>（年度培训计划）</em></div>
                 <form id="form1">
