...
<div class="bread-line">
		<s:if test="#request.columnId==1">
		<label>当前位置：</label><a href="#">首页</a>&gt;<a href="#">公告管理</a>&gt;&nbsp;公告修改
		</s:if>
		<s:elseif test="#request.columnId==2">
		<label>当前位置：</label><a href="#">首页</a>&gt;<a href="#">政策法规</a>&gt;&nbsp;政策法规修改
		</s:elseif>
</div>
...
<div class="formPage">
	...
	<div class="big_title">修改内容</div>
		...
		<tr>
			...
			<td colspan="3"><input id="subject" name="subject" type="text" maxlength="50" class="formText" valid="required" errmsg="notify.notify_zcmc_not_null"></input>
			</td>
        </tr>
        <tr id="userDiv" style="display: none;">
			<th><label>发布范围：</label></th>
