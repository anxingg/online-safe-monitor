...
<jsp:include page="../head.jsp" />
	...
	<title>企业端救援物资列表--临时</title>
	<link href="${ctx}wh/plugins/datatable/skins/datatable_default.css?version=${version}" rel="stylesheet" type="text/css"/>
	<script type="text/javascript" src="${ctx}wh/js/reliefGoods/reliefGoodsInfoList.js"></script>
	...
	<div class="list">
		<div class="searchArea">
			<ul>
				...
				<li><label>装备名称：</label><input type="text" class="formText" placeholder="" id="title"/></li>
