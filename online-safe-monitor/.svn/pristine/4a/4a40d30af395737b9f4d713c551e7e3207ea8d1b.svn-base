...
<head>
	...
	<!-- 清除分页cookie end -->
	<script type="text/javascript" src="${ctx}wh/js/safeAccident/safeAccidentStatisticsZF.js"></script>
...
<body>
	...
	<div class="list">
		<div class="searchArea">
			<ul>
				<li><label>登记时间：</label><input type="text" class="formText Wdate" id="beginTime" onfocus="WdatePicker({maxDate:'#F{$dp.$D(\'endTime\')}',skin:'default',dateFmt:'yyyy-MM-dd'})" /> - <input type="text" class="formText Wdate" id="endTime" onfocus="WdatePicker({minDate:'#F{$dp.$D(\'beginTime\')}' ,skin:'default',dateFmt:'yyyy-MM-dd'})" /></li>
