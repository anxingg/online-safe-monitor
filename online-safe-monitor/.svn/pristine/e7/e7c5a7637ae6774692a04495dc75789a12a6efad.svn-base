...
<jsp:include page="../head.jsp" />
    ...
    <script type="text/javascript" src="${ctx}wh/js/specialWorkPerson/updateSpecialWorkPerson.js?version=${version}"></script>
...
<body>
	...
	<div class="bread-line">
		<label>当前位置：</label><a href="#">首页</a>&gt;<a href="#">企业管理</a>&gt;&nbsp;特种作业人员修改
	</div>
	<div class="formPage">
	 <div class="formbg">
        <div class="big_title">修改<em>（特种作业人员）</em></div>
