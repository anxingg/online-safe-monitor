            ...
            <table width="100%" cellspacing="0" cellpadding="0" border="0" class="inputTable">
               <tbody>
                          ...
                          <tr>
                              ...
                              <td><input name="input2" type="text" style="width:150px;" class="formText" maxlength="3" id="groupOrder" onkeyup="this.value=this.value.replace(/[^0-9]/g,'')" valid="required|isNumber" errmsg="groupExt.group_order_not_null|groupExt.group_order_format_error" value="${requestScope.groupInfoVO.orderIndex}"/><font class="gray_c ml10">正序排列，值越小排序越靠前</font></td>
                          </tr>
              </tbody>
           </table>
