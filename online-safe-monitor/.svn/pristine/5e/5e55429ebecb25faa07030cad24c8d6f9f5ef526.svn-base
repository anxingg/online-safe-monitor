...
<jsp:include page="../head.jsp" />
	...
	<!-- 验证end -->
    <script type="text/javascript" src="${ctx}wh/js/companyProduct/addCompanyProduct.js?version=${version}"></script>
...
<body>
	...
	<div class="bread-line">
		<label>当前位置：</label><a href="#">首页</a>&gt;<a href="#">企业管理</a>&gt;&nbsp;企业产品新增
	</div>
	 <div class="formPage">
	 <div class="formbg">
        <div class="big_title">新增<em>（企业产品）</em></div>
