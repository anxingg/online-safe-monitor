...
//    "source","undo","redo","insertunorderedlist","insertorderedlist","unlink","link","cleardoc","selectall",
//    "searchreplace","preview","separate","insertimage","emotion","date","time","spechars","blockquote","background",
        ,labelMap:{
            'anchor':'', 'undo':''
        }
        //webAppKey
