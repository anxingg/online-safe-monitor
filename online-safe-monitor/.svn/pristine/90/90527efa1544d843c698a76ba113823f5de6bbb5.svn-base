...
<head>
	...
	<!-- 清除分页cookie end -->
	<script type="text/javascript" src="${ctx}wh/js/company/companyList.js?version=${version}"></script>
</head>
<body>
	...
	<div class="bread-line">
		<label>当前位置：</label><a href="#">首页</a>&gt;<a href="#">企业管理</a>&gt;&nbsp;企业列表
	</div>
	<div class="list">
