	...
	<input type="hidden" id="moduleName" value='<%=moduleName%>' />
       ...
       <div class="tab">
         <ul>
           ...
           <li  id="liSelectRole" style="display: none;"><a   href="javascript:void(0);"  id="btnSelectRole" >工作角色</a></li>
           <li  id="liSelectGroups" style="display: none;"><a   href="javascript:void(0);"  id="btnSelectGroups" >群组</a></li>
         </ul>  
       </div>
