      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0"  class="inputTable"  >
         <tr>
           ...
           <tr>
            ...
            <td>
                <label class="radio">
                    <input type="radio" name="configs.force_read" checked="checked" value="1"/>按级别
                </label>
                <label class="radio">
                    <input type="radio" name="configs.force_read" value="2"/>按时间
                </label>
            </td>
          </tr>
          <tr>
            ...
            <td>
                <label class="radio">
                    <input type="radio" name="configs.delete_official" checked="checked" value="1"/>显示
                </label>
                <label class="radio">
                    <input type="radio" name="configs.delete_official" value="2"/>隐藏
                </label><em class="gray_9">（审批人审批公文时是否需要填写意见）</em>
            </td>
          </tr>
          <tr>
