...
<jsp:include page="../head.jsp" />
	...
	<title>政府端应急机构列表</title>
	<link href="${ctx}wh/plugins/datatable/skins/datatable_default.css?version=${version}" rel="stylesheet" type="text/css"/>
	<script type="text/javascript" src="${ctx}wh/js/emergencyDepartment/emergencyCompanyList.js"></script>
	...
	<div class="list">
		<div class="searchArea">
			<ul>
				...
				<c:if test="${whroletype==1 }"><div class="fButton greenBtn" id="add"> <span class="add">新增</span></div></c:if>
