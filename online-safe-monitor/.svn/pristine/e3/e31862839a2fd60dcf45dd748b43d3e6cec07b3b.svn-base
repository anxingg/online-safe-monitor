...
<body>
	...
	<s:if test="#request.returnType!=11">
	<div class="bread-line">
			<s:if test="#request.columnId==1">
			<label>当前位置：</label><a href="#">首页</a>&gt;<a href="#">公告管理</a>&gt;&nbsp;查看
			</s:if>
			<s:elseif test="#request.columnId==2">
			<label>当前位置：</label><a href="#">首页</a>&gt;<a href="#">政策法规</a>&gt;&nbsp;查看
			</s:elseif>
	</div>
	</s:if>
	<div class="detailsPage" style="width:97%">
		<div class="detailbg">
		<h2 id="subject"></h2>
