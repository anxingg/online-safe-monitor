...
<!-- 导入主js -->
<script type="text/javascript" src="${ctx}js/logined/localsegment/localWeihuImport.js?version=${version}"></script>
<style type="text/css">
...
<div class="importBox">
    ...
    <p style="text-align:left;padding-left:140px"><span>暂时只支持导入Excel格式文件，后缀名为.xls</span><a href="${ctx}down/segmentList.xls" id="importModule" class="ml10">获取模板？</a></p>
</div>
</body>
</html>
