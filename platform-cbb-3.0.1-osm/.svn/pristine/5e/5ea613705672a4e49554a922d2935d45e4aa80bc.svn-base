...
public class MyApplyServiceImpl implements MyApplyService {
	...
	public void approve(ModuleCode moduleCode, String instanceId,
			UserInfo approver, String advice,String state) {
		...
		if(wait!=null){
			...
			processed.setCategoryName(wait.getCategoryName());
			processed.setTitle(wait.getTitle());
			processed.setInstanceId(wait.getInstanceId());
			...
			processed.setCreaterName(wait.getCreaterName());
