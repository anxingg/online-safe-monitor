...
public class RedPointUtil {
    ...
    public static void pushInfo(JPushClient jpush,String tag,Map<String,Object> extra,int companyId){
    	...
    	Gson json = new Gson();
    	pushPlatService.pushJpushToPlat(companyId, checkTest(androidTag),PLAT_TYPE.ANDROID, null,"最新消息", json.toJson(extra), JPUSH_PUSH_TYPE.TAG,null);
    	pushPlatService.pushJpushToPlat(companyId, checkTest(iosTag), PLAT_TYPE.IOS, null,"最新消息", json.toJson(extra), JPUSH_PUSH_TYPE.TAG,null);
