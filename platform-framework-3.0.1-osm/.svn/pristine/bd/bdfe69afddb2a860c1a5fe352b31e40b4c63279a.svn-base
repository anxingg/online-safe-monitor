 ...
 *
 */
public class MappingGsonHttpMessageConverter extends
	...
	public MappingGsonHttpMessageConverter() {
		super(new MediaType("application", "plain", DEFAULT_CHARSET));
	}
...
//		Gson gson = new Gson();
//		gson.tojson
		outputMessage.getBody().write(o.toString().getBytes("UTF-8"));
	}
