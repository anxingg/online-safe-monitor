...
public class UserDao<T extends UserInfo>  extends BaseDao<UserInfo, Integer> implements Serializable{
    ...
    public List<UserInfo> findUsersByRoleCodeAndGroup(String roleCode,int groupId){
    	String hql = "groupId = ? and userId in (select userId from RoleUser where roleId in (select roleId from RoleInfo where roleCode = ?))";
    	return super.partition().findAll(hql,groupId,roleCode);
    }
	...
	//	String hql ="select a from UserInfo a where companyId=31146 and isDelete=0";
        ...
        while (it.hasNext())
        {
        	...
        	u.setUserId(map[0]!=null?(Integer)map[0]:0);
        	u.setPhone(map[1]!=null && !"".equals(1)?(String)map[1]:null);
        	u.setGroupId(map[2]!=null?(Integer)map[2]:null);
        	u.setUserName(map[3]!=null&& !"".equals(map[3])?(String)map[3]:null);
        	u.setSex(map[4]!=null?(Integer)map[4]:null);
        	...
        	u.setOrderIndex(map[13]!=null?(Integer)map[13]:null);
        	u.setvNum(map[14]!=null&& !"".equals(map[14])?(String)map[14]:null);
        	u.setVNum(map[14]!=null&& !"".equals(map[14])?(String)map[14]:null);
        	u.setIsVirtual(map[15]!=null?(Integer)map[15]:null);
        	u.setLinkId(map[16]!=null?(Integer)map[16]:null);
        	u.setUserState(map[17]!=null?(Integer)map[17]:null);
        	u.setUserPower(map[18]!=null?(Integer)map[18]:null);
        	u.setSignName(map[19]!=null&& !"".equals(map[19])?(String)map[19]:null);
        	u.setRole(map[20]!=null?(Integer)map[20]:null);
        	...
        	u.setIsDelete(map[24]!=null?(Integer)map[24]:0);
        	u.setMobileShowState(map[25]!=null?(Integer)map[25]:0);
