...
//		return getForkGroup(g); 
	...
	public void updateGroupTime(int groupId){
		GroupInfo info = groupDao.findOne(groupId);
		info.setLastUpdateTime(new Date());
		groupDao.saveOrUpdate(info);
	}
	...
	//add by jiayq 2014//11/28
	    ...
	    /**
	     * 通过groupids字符串获得部门/群组名称
	     * @return Map<groupId,groupName>
	     */
	    public Map<Integer,String> getGroupMapByIds(Integer companyId,String groupIds){
	    	Map<Integer,String> map = new HashMap<Integer, String>();
	    	List<GroupInfo> list = groupDao.getGroupListByIds(companyId, groupIds);
		...
		public void deleteGroupByUserIds(String userIds){
			groupDao.deleteGroupByUserIds(userIds);
		}
}
