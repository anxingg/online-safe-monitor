...
public class WapNotifyImpl extends BaseServiceImpl<Notify> implements IWapNotify{
	...
	public Page<Notify> viewList(Pageable pageable,String subject,int userId, int notifyType,int columnId) {
		return wapNotifyDao.viewList(pageable,subject,userId,notifyType,columnId);
	}
	@Transactional(readOnly=true)
