...
public interface INotify extends BaseService<Notify> {
	 ...
	 * @return
	 */
	public Page<Notify> viewList(Pageable pageable, Integer userId,
			int notifyType, String searchWord, Integer columnId,
			Integer isShowOut);
	 ...
	 * @return
	 */
	public Page<Notify> approveList(Pageable pageable, Integer userId,
			Integer notifyType, String subject, Date beginDate, Date endDate,
	 ...
	 */
	@Deprecated
	public Page<Map<String, Object>> clmViewList(Pageable pageable,
			Integer userId, int notifyType, String searchWord,
			Integer columnId, String groupId);
	 ...
	 * 分页统计查询
	 * @param pageable
	 * @param nsr NotifyAccidentStatisticsResult对象，需传的参数有：beginDate、endDate、notifyType、columnId
	 * @return Page<NotifyAccidentStatisticsResult>
	 */
	Page<NotifyStatisticsResult> findStatisticsResultByPage(
